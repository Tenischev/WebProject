...
<div style="height: 100%">
    ...
    <form method="post">
        <div style="height: 80%;  width: 60%; margin: 2% 20%;  min-height: 400px; background: #E5E5E5; border: solid 1px black; padding: 10px">
            <input type="text" autofocus required name="name" maxlength="15" placeholder="Название списка" tabindex="1" style="font-size: 20px; width: 100%">
            <hr>
            ...
            <hr>
            <p style="margin: 0"><input type="checkbox" tabindex="3" name="public"><label>Сделать публичным</label><input type="submit" name="create" tabindex="4" value="Создать" style="margin: 0 0 0 50% "></p>
        </div>
    </form>
</div>
</body>
